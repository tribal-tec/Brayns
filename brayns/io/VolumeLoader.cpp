...
const Property PROP_DIMENSIONS = {"dimensions",
                                  ...
                                  Property::UserInfo{"Dimensions"}};
const Property PROP_SPACING = {"spacing", std::array<double, 3>({{0, 0, 0}}),
                               Property::UserInfo{"Spacing"}};
const Property PROP_TYPE = {"type",
                            brayns::enumToString(brayns::DataType::UINT8),
                            brayns::enumNames<brayns::DataType>(),
                            Property::UserInfo{"Type"}};
}
    ...
    const size_t defaultMaterialId BRAYNS_UNUSED) const
{
    ...
    properties.setProperty(
        {PROP_DIMENSIONS.name, dimensions, PROP_DIMENSIONS.userInfo});
    properties.setProperty({PROP_SPACING.name, spacing, PROP_SPACING.userInfo});
    properties.setProperty({PROP_TYPE.name, brayns::enumToString(type),
                            PROP_TYPE.enums, PROP_TYPE.userInfo});
