...
public:
    ...
    //    void setShading(const ShadingType value) { _updateValue(_shading,
    //    value); }

    //    /** Enables photon emission according to the radiance value of the
    //     * material */
    //    bool getLightEmittingMaterials() const { return
    //    _lightEmittingMaterials; }
    ...
    //    }
    //    /**
    //       Defines if touch detection applies if the material of the
    //       surrounding
    ...
    //    */
    //    const Vector3f& getDetectionFarColor() const { return
    //    _detectionFarColor; }
