...
template <typename T>
void _addProp(const std::shared_ptr<PropertyMap::Property> prop,
...
template <>
void _addProp<std::string>(const std::shared_ptr<PropertyMap::Property> prop,
...
void _addPropArray(const std::shared_ptr<PropertyMap::Property> prop,
                   rapidjson::Value& properties, rapidjson::Document& schema)
{
    using namespace rapidjson;
...
template <typename T>
void _addProperty(rapidjson::Document& document, PropertyMap::Property& prop)
{
    ...
    for (const auto& obj : objs)
    {
        ...
        for (auto prop : obj.second.getProperties())
        {
            ...
            case PropertyMap::Property::Type::Vec2f:
                _addPropArray<float, 2>(prop, properties, schema);
                break;
            case PropertyMap::Property::Type::Vec2i:
                _addPropArray<int32_t, 2>(prop, properties, schema);
                break;
            case PropertyMap::Property::Type::Vec3f:
                _addPropArray<float, 3>(prop, properties, schema);
                break;
            case PropertyMap::Property::Type::Vec3i:
                _addPropArray<int32_t, 3>(prop, properties, schema);
                break;
            case PropertyMap::Property::Type::Vec4f:
                _addPropArray<float, 4>(prop, properties, schema);
                break;
            }
        }
...
inline std::string to_json(const brayns::PropertyMap& obj)
{
    ...
    for (auto prop : obj.getProperties())
    {
        ...
        case PropertyMap::Property::Type::Bool:
            ...
            break;
        case PropertyMap::Property::Type::Vec2f:
            brayns::_addProperty<std::array<float, 2>>(json, *prop);
            break;
        case PropertyMap::Property::Type::Vec2i:
            brayns::_addProperty<std::array<int32_t, 2>>(json, *prop);
            break;
        case PropertyMap::Property::Type::Vec3f:
            brayns::_addProperty<std::array<float, 3>>(json, *prop);
            break;
        case PropertyMap::Property::Type::Vec3i:
            brayns::_addProperty<std::array<int32_t, 3>>(json, *prop);
            break;
        case PropertyMap::Property::Type::Vec4f:
            brayns::_addProperty<std::array<float, 4>>(json, *prop);
            break;
        }
    }
